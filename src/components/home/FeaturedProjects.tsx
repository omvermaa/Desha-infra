...
// import { useProjects } from "/OM/WEB DEV/Desha infra/src/hooks/use-project";
// import { ArrowRight } from "lucide-react";
// import sukoon from "@/assets/sukoon.webp";
// import desha1 from "@/assets/desha1.webp";


// function ProjectCard({ project, index }: { project: { id: number, title: string, slug: string, location: string, completionDate: string, heroImage: string, description: string }, index: number }) {
...
//     >
//       <Link href={`/projects/${project.slug}`} className="block overflow-hidden relative aspect-[4/5] sm:aspect-video w-full">
...
//         <div className="absolute bottom-0 left-0 p-8 z-20 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
//           <p className="text-white text-sm tracking-widest uppercase mb-2">{project.location}</p>
...
//         <div>
//           <h3 className="font-display text-2xl md:text-3xl font-medium mb-2 group-hover:text-accent transition-colors">
//             {project.title}
//           </h3>
//           <p className="text-muted-foreground text-sm uppercase tracking-widest">{project.completionDate}</p>
//         </div>
//         <Link href={`/projects/${project.slug}`} className="w-12 h-12 rounded-full border border-border flex items-center justify-center group-hover:bg-foreground group-hover:text-background group-hover:border-foreground transition-all duration-300">
//           <ArrowRight size={20} strokeWidth={1.5} className="group-hover:-rotate-45 transition-transform duration-300" />
//         </Link>
//       </div>
//     </motion.div>
//   );
...
//       location: "Miami, USA",
//       completionDate: "2025",
//       // luxury interior design apartment
//       heroImage: desha1,
//       description: "Redefining coastal luxury with panoramic ocean views."
//     }
//   ];
...
//           className="flex flex-col md:flex-row text-center justify-between sm:items-end mb-24 gap-8"
//         >
//           <div className="max-w-2xl ">
//             <h2 className="text-accent text-sm font-bold tracking-[0.3em] uppercase mb-6">Selected Works</h2>
//             <h3 className="font-display text-5xl md:text-6xl lg:text-7xl leading-tight">
//               Masterpieces in<br />
//               <span className="italic text-muted-foreground">concrete & light</span>
//             </h3>
//           </div>
//           <Link href="/projects" className="group flex items-center gap-4 text-sm tracking-widest uppercase font-semibold link-hover pb-1">
//             View All Projects 
//             <ArrowRight size={16} className="sm:block hidden group-hover:translate-x-2 transition-transform" />
//           </Link>
//         </motion.div>
